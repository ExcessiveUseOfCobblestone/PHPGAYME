<?php
/* Nilkana - Turn-based strategy game
...
$lang['en-US'] += array(
	...
	'AID_NEED_TURNS'		=> 'You do not have enough action points to send an aid shipment!',
	...
	'AID_HEADER'			=> 'Sending aid requires 2 action points and at least %1$s %2$s.<br />We can send %3$s at this time.<br />We can send an additional shipment every hour.',
	...
	'BANK_INTEREST_DESCRIPTION'	=> 'Interest is calculated per turn (52 action points = 1 APR year)',
	...
	'CASH_NOT_ENOUGH_TURNS'		=> 'You cannot spend that many action points making money!',
	'CASH_SPECIFY_TURNS'		=> 'Please specify a number of action points to spend making money.',
	...
	'CASH_LABEL'			=> 'Spend how many action points making money?',
	'CASH_SUBMIT'			=> 'Make Money',

	// pages/faction
	'CLAN_TITLE'			=> 'Factions',
	'CLAN_UNAVAILABLE_START'	=> 'Factions cannot be accessed before the round has begun.',
	'CLAN_UNAVAILABLE_END'		=> 'Factions cannot be accessed after the round has ended.',
	'CLAN_UNAVAILABLE_PROTECT'	=> 'Factions cannot be accessed while still under protection.',
	'CLAN_UNAVAILABLE_ADMIN'	=> 'Factions cannot be accessed by administrative accounts.',
	'CLAN_UNAVAILABLE_CONFIG'	=> 'Factions are not available in this game.',

	'CLAN_ALREADY_MEMBER'		=> 'You are already in a faction!',
	'CLAN_NOT_MEMBER'		=> 'You are not in a faction!',

	'CLAN_CREATE_TOO_LATE'		=> 'You cannot create a faction this late in the game.',
	'CLAN_CREATE_TOO_SOON'		=> 'You cannot create a new faction until at least %1$s hours have passed since leaving your previous faction.',
	'CLAN_CREATE_NEED_NAME'		=> 'You must specify a name for your new faction.',
	'CLAN_CREATE_NAME_INVALID'	=> 'That faction name is not allowed!',
	'CLAN_CREATE_NAME_TOO_LONG'	=> 'That faction name is too long. Please choose a shorter one.',
	'CLAN_CREATE_NAME_IN_USE'	=> 'The faction name specified is already in use. Please choose another one.',
	// Only used with default language
	'CLAN_CREATE_DEFAULT_TITLE'	=> 'Faction %1$s',
	// Only used with default language
	'CLAN_CREATE_DEFAULT_MOTD'	=> 'Welcome to faction %1$s!',
	'CLAN_CREATE_COMPLETE'		=> 'You have successfully created the faction %1$s.',

	'CLAN_JOIN_TOO_SOON'		=> 'You cannot join a new faction until at least %1$s hours have passed since leaving your previous faction.',
	'CLAN_JOIN_NEED_CLAN'		=> 'You must select a faction to join!',
	'CLAN_JOIN_DISBANDED'		=> 'The faction you selected has already been disbanded.',
	'CLAN_JOIN_IS_FULL'		=> 'Sorry, that faction is currently full. Wait until somebody leaves the faction or more empires have been created, then try again.',
	'CLAN_JOIN_COMPLETE'		=> 'You are now a member of %1$s.',

	'CLAN_INVITE_NEED_INVITE'	=> 'You have not been invited to join that faction!',
	'CLAN_INVITE_WRONG_EMPIRE'	=> 'The invitation you selected was for another empire!',
	'CLAN_INVITE_WRONG_CLAN'	=> 'The invitation you selected was for a different faction!',

	'CLAN_LEAVE_TOO_SOON'		=> 'You cannot leave this faction until you have been a member for at least %1$s hours.',
	'CLAN_LEAVE_NEED_CONFIRM'	=> 'You must check the confirmation box in order to leave your faction!',
	'CLAN_LEAVE_OTHER_MEMBERS'	=> 'You cannot simply abandon the other members of your faction!',
	'CLAN_LEAVE_COMPLETE_DISBAND'	=> 'Your faction, %1$s, has been disbanded.',
	'CLAN_LEAVE_COMPLETE'		=> 'You have left the faction %1$s.',

	'CLAN_SHARE_COMPLETE'		=> 'You are now using your forces to help fellow faction members.',
	'CLAN_UNSHARE_COMPLETE'		=> 'Your forces will be available for your own defense in %1$s hours.',

	'CLAN_LINK_LABEL'		=> '%1$s\'s Home Page',
	'CLAN_MEMBER_HEADER'		=> 'Faction Info for <i>%1$s</i>',
	'CLAN_LINK_FORUM'		=> 'Faction Forum',
	'CLAN_LINK_MANAGE'		=> 'Faction Management',
	...
	'CLAN_UNSHARE_SUBMIT'		=> 'Don\'t Use my Forces for Faction Defense',
	'CLAN_SHARE_SUBMIT'		=> 'Use my Forces for Faction Defense',
	...
	'CLAN_SHARE_HEADER'		=> 'Faction Shared Defense',
	'CLAN_UNSHARE_HEADER'		=> ' (for %1$s minutes longer)',
	'CLAN_DISBAND_SUBMIT'		=> 'Disband Faction',
	'CLAN_DISBAND_CONFIRM'		=> 'Yes, I really want to disband!',
	'CLAN_LEAVE_SUBMIT'		=> 'Leave Faction',
	'CLAN_LEAVE_CONFIRM'		=> 'Yes, I really want to leave!',

	'CLAN_NONMEMBER_HEADER'		=> 'The world can be a dangerous place - you would be wise to create or join a faction for added protection.',
	'CLAN_JOIN_LABEL'		=> 'Join a Faction',
	'CLAN_JOIN_LABEL_WITH_TITLE'	=> '%1$s - %2$s',
	'CLAN_JOIN_SUBMIT'		=> 'Join Faction',

	'CLAN_INVITE_HEADER'		=> 'Faction Invitations',
	'CLAN_INVITE_TEMP_LABEL'	=> '(Temporary)',
	'CLAN_INVITE_PERM_LABEL'	=> '(Permanent)',

	'CLAN_JOIN_NONE_AVAILABLE'	=> 'No factions have been created yet - be the first to create your own!',
	'CLAN_JOIN_NONE_UNAVAILABLE'	=> 'Unfortunately, there are no factions available for you to join, and it is too late to create your own.',
	'CLAN_JOIN_LATE'		=> 'The current round is nearly over - you may not create or join a faction at this time.',
	'CLAN_CREATE_LABEL'		=> 'Create a Faction',
	'CLAN_CREATE_SUBMIT'		=> 'Create Faction',

	// pages/factionforum
	'CLANFORUM_TITLE'		=> 'Faction Forum',
	'CLANFORUM_UNAVAILABLE_START'	=> 'The faction forum cannot be accessed before the round has begun.',
	'CLANFORUM_UNAVAILABLE_END'	=> 'The faction forum cannot be accessed after the round has ended.',
	'CLANFORUM_UNAVAILABLE_PROTECT'	=> 'The faction forum cannot be accessed while still under protection.',
	'CLANFORUM_UNAVAILABLE_ADMIN'	=> 'The faction forum cannot be accessed by administrative accounts.',
	'CLANFORUM_UNAVAILABLE_CONFIG'	=> 'Factions are not available in this game.',
	...
	'CLANFORUM_TOPIC_WRONG_CLAN'	=> 'You specified thread is in another faction\'s forum!',
	...
	'CLANFORUM_REPLY_NEWS'		=> 'You are not allowed to post messages in your faction\'s News thread!',
	...
	'CLANFORUM_EDIT_NEWS'		=> 'You are not allowed to edit messages in your faction\'s News thread!',
	...
	'CLANFORUM_DELETE_NEWS'		=> 'You are not allowed to delete messages in your faction\'s News thread!',
	...
	'CLANFORUM_DELETE_CANNOT_NEWS'	=> 'You cannot delete your faction\'s News thread!',
	...
	'CLANFORUM_SUBJECT_NEWS'	=> 'Faction News',
	...
	// pages/factionstats
	'CLANSTATS_TITLE'		=> 'Faction Statistics',
	'CLANSTATS_HEADER'		=> 'Faction Rankings (%1$s Member Minimum)',
	'CLANSTATS_NO_CLANS'		=> 'No factions have been created!',
	'CLANSTATS_TOO_SMALL'		=> '%1$s/%2$s (%3$s) factions don\'t have enough members to make this list.',
	'CLANSTATS_INDEPENDENT'		=> '%1$s/%2$s (%3$s) empires are independent.',

	// pages/contacts
	'CONTACTS_TITLE'		=> 'Faction Contacts',
	'CONTACTS_HEADER'		=> 'Whether you are looking to join a faction, negotiate an alliance, or propose a peace treaty, you can find the appropriate people to contact here.',
	'CONTACTS_EMP_NONE'		=> '(none)',

	// pages/credits
	'CREDITS_TITLE'			=> 'Credits',
	'CREDITS_HEADER'		=> 'Nilkana Credits',
	...
	'DEMOLISH_NOT_ENOUGH_TURNS'	=> 'You do not have enough action points to demolish that many structures!',
	...
	'FARM_NOT_ENOUGH_TURNS'		=> 'You cannot spend that many action points farming!',
	'FARM_SPECIFY_TURNS'		=> 'Please specify a number of action points to spend farming.',
	...
	'FARM_LABEL'			=> 'Spend how many action points farming?',
	'FARM_SUBMIT'			=> 'Farm',

	// pages/graveyard
	'GRAVEYARD_TITLE'		=> 'Graveyard',
	'GRAVEYARD_HEADER'		=> 'Here lies the empires whose leaders were not strong enough in body, mind, and spirit to survive the ravages of the world of Nilkana.',
	...
	'GRAVEYARD_LABEL_KILLED_CLAN'	=> 'Killed by %1$s of faction %2$s',
	...
	'HISTORY_ERROR_NO_CLAN'		=> 'This round did not make use of factions.',
	...
	'HISTORY_CLAN_TITLE'		=> 'History - Factions',
	'HISTORY_CLAN_HEADER'		=> 'Faction Rankings (%1$s Member Minimum)',
	'HISTORY_CLAN_NO_CLANS'		=> 'There were no significant factions at the end of this round!',
	'HISTORY_CLAN_TOO_SMALL'	=> '%1$s/%2$s (%3$s) factions didn\'t have enough members to make this list.',
	'HISTORY_CLAN_INDEPENDENT'	=> '%1$s/%2$s (%3$s) empires were <a href="%4$s">independent</a>.',
	'HISTORY_MEMBER_TITLE'		=> 'History - Faction Members',
	'HISTORY_MEMBER_HEADER_CLAN'	=> 'Faction Member Listing',
	'HISTORY_MEMBER_HEADER_NOCLAN'	=> 'Unfactionned Empire Listing',

	// pages/land
	'LAND_TITLE'			=> 'Exploration',
	'LAND_NOT_ENOUGH_TURNS'		=> 'You cannot spend that many action points exploring!',
	'LAND_SPECIFY_TURNS'		=> 'Please specify a number of action points to spend exploring.',
	...
	'LAND_LABEL'			=> 'Spend how many action points exploring?',
	'LAND_SUBMIT'			=> 'Explore',
	...
	'MAGIC_NEED_TURNS'		=> 'You do not have enough action points to cast that spell!',
	'MAGIC_NEED_TURNS_AGAIN'	=> 'You do not have enough action points to cast that spell again!',
	...
	'MAGIC_ENEMY_REFUSE_CLAN'	=> 'You cannot cast spells on an empire in your own faction.',
	'MAGIC_ENEMY_REFUSE_ALLY'	=> 'Your faction has a standing alliance with that empire - you would be a fool to violate it.',
	...
	'MAIN_UNDER_PROTECTION'		=> 'Under New Player Protection (%1$s action points)',
	'MAIN_TURN_RATE'		=> 'You get %1$s every %2$s',
	'MAIN_TURNS_STOPPED'		=> 'Action Points are currently stopped.',
	...
	// pages/manage/faction
	'MANAGE_CLAN_TITLE'		=> 'Factions',
	'MANAGE_CLAN_UNAVAILABLE_START'	=> 'Factions cannot be accessed before the round has begun.',
	'MANAGE_CLAN_UNAVAILABLE_END'	=> 'Factions cannot be accessed after the round has ended.',
	'MANAGE_CLAN_UNAVAILABLE_PROTECT'=> 'Factions cannot be accessed while still under protection.',
	'MANAGE_CLAN_UNAVAILABLE_ADMIN'	=> 'Factions cannot be accessed by administrative accounts.',
	'MANAGE_CLAN_UNAVAILABLE_CONFIG'	=> 'Factions are not available in this game.',
	'MANAGE_CLAN_NEED_PERMISSION'	=> 'You do not have administrative authority in this faction!',

	'MANAGE_CLAN_NO_SUCH_CLAN'	=> 'The faction you selected does not exist!',
	'MANAGE_CLAN_NO_SUCH_RELATION'	=> 'The selected faction relation does not exist!',
	'MANAGE_CLAN_INVALID_RELATION'	=> 'You have selected an invalid relation!',
	'MANAGE_CLAN_CLAN_IS_GONE'	=> 'The faction you selected no longer exists!',

	'MANAGE_CLAN_ALLY_REQUEST_TOO_MANY'	=> 'Your faction cannot request any more alliances at this time.',
	...
	'MANAGE_CLAN_ALLY_CANCEL_COMPLETE'	=> 'You have retracted your faction\'s request for alliance with <b>%1$s</b>.',
	'MANAGE_CLAN_ALLY_ACCEPT_SELF_TOO_MANY'	=> 'Your faction cannot form any more alliances at this time.',
	'MANAGE_CLAN_ALLY_ACCEPT_OTHER_TOO_MANY'	=> 'Your companion faction cannot form any more alliances at this time.',
	...
	'MANAGE_CLAN_ALLY_STOP_COMPLETE'	=> 'You have terminated your faction\'s alliance with <b>%1$s</b>.',

	'MANAGE_CLAN_WAR_DECLARE_TOO_MANY'	=> 'Your faction does not have the resources to engage in any more wars.',
	...
	'MANAGE_CLAN_WAR_REJECT_TOO_MANY'	=> 'Your faction does not have the resources to take the offensive in this war.',
	...
	'MANAGE_CLAN_PASSWORD_NEED_PERMISSION'	=> 'You are not allowed to change your faction\'s password!',
	'MANAGE_CLAN_PASSWORD_COMPLETE'	=> 'Your faction password has been changed.',
	'MANAGE_CLAN_LOGO_NEED_PERMISSION'	=> 'You are not allowed to change your faction\'s logo!',
	'MANAGE_CLAN_LOGO_TOO_LONG'	=> 'Faction logo URL is too long!',
	'MANAGE_CLAN_LOGO_INVALID'	=> 'You must specify a valid URL for your faction logo!',
	'MANAGE_CLAN_LOGO_COMPLETE'	=> 'Faction logo changed.',
	'MANAGE_CLAN_TITLE_NEED_PERMISSION'	=> 'You are not allowed to change your faction\'s title!',
	'MANAGE_CLAN_TITLE_REQUIRED'	=> 'You cannot remove your faction title!',
	'MANAGE_CLAN_TITLE_TOO_LONG'	=> 'Faction title is too long!',
	'MANAGE_CLAN_TITLE_INVALID'	=> 'That faction title is not allowed!',
	'MANAGE_CLAN_TITLE_COMPLETE'	=> 'Faction title changed.',
	'MANAGE_CLAN_URL_NEED_PERMISSION'	=> 'You are not allowed to change your faction\'s homepage!',
	'MANAGE_CLAN_URL_TOO_LONG'	=> 'Faction homepage URL is too long!',
	'MANAGE_CLAN_URL_INVALID'	=> 'You must specify a valid URL for your faction homepage!',
	'MANAGE_CLAN_URL_COMPLETE'	=> 'Faction homepage changed.',

	'MANAGE_CLAN_RANKS_NEED_PERMISSION'	=> 'You are not allowed to alter faction ranks or remove members!',
	'MANAGE_CLAN_RANKS_REMOVE_NOT_IN_CLAN'	=> 'That empire is not in this faction!',
	'MANAGE_CLAN_RANKS_REMOVE_IS_SPECIAL'	=> 'You may not remove a member who is in a position of authority!',
	'MANAGE_CLAN_RANKS_REMOVE_COMPLETE'	=> 'You have removed <b>%1$s</b> from your faction.',
	'MANAGE_CLAN_RANKS_CHANGE_LEADER_PERMISSION'	=> 'Only the current faction leader can appoint a new leader!',
	'MANAGE_CLAN_RANKS_CHANGE_ASST_PERMISSION'	=> 'Only the current faction leader can appoint a new assistant leader!',
	...
	'MANAGE_CLAN_RANKS_NEED_LEADER'	=> 'You must select an empire to be your faction leader!',
	'MANAGE_CLAN_RANKS_CONFLICT'	=> 'You cannot assign multiple positions of authority to a single empire!',
	'MANAGE_CLAN_RANKS_WRONG_CLAN'	=> 'You cannot assign a position of authority to an empire not in our faction!',
	'MANAGE_CLAN_RANKS_LEADER_GONE'	=> 'The empire you selected for faction leader does not exist!',
	...
	'MANAGE_CLAN_INVITE_ADMIN'	=> 'You cannot invite an Administrator to join your faction!',
	'MANAGE_CLAN_INVITE_DISABLED'	=> 'That empire has been locked by Administration for further investigation - you may not invite it to join your faction.',
	'MANAGE_CLAN_INVITE_PERM_NEED_PERMISSION'	=> 'You do not have permission to permanently invite empires to join this faction!',
	'MANAGE_CLAN_INVITE_ALREADY_MEMBER'		=> 'That empire is already a member of this faction!',
	'MANAGE_CLAN_INVITE_WRONG_CLAN'			=> 'That empire has already joined another faction!',
	'MANAGE_CLAN_INVITE_ALREADY_PERM'		=> 'That empire has already been permanently invited to this faction.',
	'MANAGE_CLAN_INVITE_ALREADY_INVITED'		=> 'That empire has already been invited to this faction.',
	...
	'MANAGE_CLAN_UNINVITE_WRONG_CLAN'		=> 'The invitation you selected does not belong to this faction!',
	...
	'MANAGE_CLAN_HEADER'		=> 'Faction Management for <i>%1$s</i>',
	...
	'MANAGE_CLAN_RELATION_WARNING'	=> 'The leaders of these factions will be notified of the actions you take here!<br />Once you take action on a relation, you must wait %1$s hours before you will be allowed to change it again!',
	'MANAGE_CLAN_RELATION_REMOVE'	=> 'Remove?',
	'MANAGE_CLAN_PASSWORD_LABEL'	=> 'Change Faction Password',
	'MANAGE_CLAN_PASSWORD_SUBMIT'	=> 'Change Password',
	'MANAGE_CLAN_TITLE_LABEL'	=> 'Change Faction Title',
	'MANAGE_CLAN_TITLE_SUBMIT'	=> 'Change Title',
	'MANAGE_CLAN_LOGO_LABEL'		=> 'Change Faction Logo URL',
	'MANAGE_CLAN_LOGO_SUBMIT'	=> 'Change Logo',
	'MANAGE_CLAN_URL_LABEL'		=> 'Change Faction Homepage URL',
	...
	'MANAGE_EMPIRE_POLYMORPH_NEED_TURNS'	=> 'You do not have enough action points!',
	...
	'MANAGE_EMPIRE_POLYMORPH_REQUIREMENT'	=> 'Requires %1$s action points,<br />%2$s %3$s, and<br />at least 75%% health',
	'MANAGE_EMPIRE_POLYMORPH_NOPENALTY'	=> 'No penalty<br />(no action points used yet)',
	...
	'MILITARY_ALLY_DEFENSE'		=> 'As your army moves forward, your target calls its factionmates for help, and reinforcements arrive from %1$s...',
	...
	'MILITARY_NEED_TURNS'		=> 'You do not have enough action points to launch an attack!',
	...
	'MILITARY_REFUSE_CLAN'		=> 'You cannot attack an empire in your own faction.',
	'MILITARY_REFUSE_ALLY'		=> 'Your faction has a standing alliance with that empire - you would be a fool to violate it.',
	...
	'SEARCH_LABEL_CLAN'		=> 'Member of Faction:',
	'SEARCH_LABEL_CLAN_ANY'		=> 'Any Faction',
	...
	'SIGNUP_COMPLETE'		=> 'Welcome to the world of Nilkana, <b>%1$s</b>! Your validation code has been sent to %2$s.',
	...
	'SIGNUP_HEADER'			=> '<i>Nilkana</i>: Signup Form',
	'SIGNUP_WELCOME_FIRST'		=> 'Welcome to %1$s!<br />'.
						'Nilkana is a turn-based strategy game in which your goal is to build the most powerful empire by whatever means necessary, whether through diplomacy or war. More information can be found in the game\'s <a href="?location=pguide">Guide</a>.<br />'.
	...
	'STATUS_OTHER_WRONG_CLAN'	=> 'You may only view the status of other empires within your faction!',
	...
	'STATUS_FOREIGN_CLAN'		=> 'Member of Faction',
	...
	// pages/topfactions (shared with factionstats)
	'TOPCLANS_TITLE'		=> 'Top Factions',
