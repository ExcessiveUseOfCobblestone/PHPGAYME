...
if(isset($_POST['register'])){
    ...
    if($username == "" || $password == "" || $email == ""){
        ...
        if(mysql_num_rows($register1) > 0){
            ...
            $ins1 = mysql_query("INSERT INTO `stats` (`health`,`gold`,`attack`,`defense`,`food`,`income`,`farming`,`mana`,`turns`,`kingid`) VALUES (100,100,10,10,100,10,11,0,100,0)") or die(mysql_error());
